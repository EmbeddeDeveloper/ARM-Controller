//**************************************************************************
//
//           MMA7455 Accelerometer (SPI) + LEDs  +LCD + UART
//
//**************************************************************************
//  FileName:           main.c
...
//  mode using MMA7455 accelerometer. The raw data is sent over serial.	The g
//	settings can be switched using Push Button S1.
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
void sendSerial(void)
{
	...
	zRead=AccelRead(ZAXIS); //Read Z Axis

	zRead+=AccelRead(ZAXIS);
	zRead=(int)zRead/2.0;
	...
	Uart0PutNum((int)xRead,4);
	Uart0PutCh(',');
	Uart0PutNum((int)yRead,4);
	Uart0PutCh(',');
	Uart0PutNum((int)zRead,4);
